...
def turn_to_closest(*, angular_speed = 60, encoder = 1):
    ENCODERReset(encoder)
    VWTurn(360, angular_speed)
    ...
    VWTurn(target_angle, angular_speed); VWWait()

def follow_wall_until_distance(stop_distance_mm: int, *, wall_distance_mm: Optional[int] = None, speed = 200, psd = PSD_RIGHT):
